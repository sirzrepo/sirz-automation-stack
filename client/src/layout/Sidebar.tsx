      ...
      subItems: [
        {
          ...
          tooltipText: 'Lead classifier'
        },
        {
          icon: <FaRobot className="text-lg" />,
          label: 'Content creation',
          path: '/agent/contentCreation',
          tooltipText: 'Content creation'
        },
        {
          icon: <FaRobot className="text-lg" />,
          label: 'Logo creator',
          path: '/agent/logoCreator',
          tooltipText: 'Logo creator'
        },
        {
          icon: <FaRobot className="text-lg" />,
          label: 'Data analyst',
          path: '/agent/dataAnalyst',
          tooltipText: 'Data analyst'
        },
        {
          icon: <FaRobot className="text-lg" />,
          label: 'Chat',
                        ...
                        {item.subItems?.map((subItem, subIndex) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <Tippy
                                  content={subItem.tooltipText ? subItem.tooltipText : null}
                                  placement="top"
                                  animation="scale"
                                  delay={[200, 400]}
                                  theme="silver"
