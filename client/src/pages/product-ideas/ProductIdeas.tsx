...
export default function ProductIdeas() {
  ...
  const fetchIdeas = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get(`${BASE_URL}/api/project-ideas/userId/${userId}`);
      ...
      {isLoading ? (
        ...
        <div className="w-full bg-[#FAFAFA] flex justify-center items-center py-12 rounded-sm relative">
          <section className="text-center">
            ...
            <p className="text-lg mb-10">No project idea created yet</p>
            <Button
              text="+ Create new project idea"
              onClick={() => dispatch(openModal("create_project_idea"))}
