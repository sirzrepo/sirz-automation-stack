    ...
    return (
        <div className=" ">
                ...
                >
                    ...
                    {automationStack.map((data, index) => (
                        <motion.div 
                            ...
                            key={index} 
                            className='bg-colorLight text-center cursor-pointer flex flex-col items-center text-sm dark:bg-colorDark px-4 py-5 text-zinc-600'
                            variants={fadeInUp}
                            whileHover={{ scale: 1.05 }}
                        >
            ...
            >
                ...
                <div className="sm:w-[50%] w-[95%] mx-auto sm:mt-8 mt-5 px-4">
