...
import vidImg from '../../assets/img/Frame 2609733.png';
...
export default function Home() {
    ...
    return (
        <div className=" ">
                    ...
                    >
                        {
                            automationCards.map((data, index) => (
                                ...
                                >
                                    ...
                                    <div className=''>
                                        <h4 className='font-bold py-2'>{data.title}</h4>
                                    ...
                                    <img src={data.img} alt="" className=' sm:h-[500px] h-[300px] object-cover h-full w-full ' />
                                </motion.div>
                            ))
                        }
                    </motion.div>
            ...
            <motion.section 
                className='bg-colorLight sm:w-[80%] w-[90%] mx-auto dark:bg-colorDark'
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                viewport={{ once: true }}
                transition={{ duration: 0.8 }}
            >
                <div className=' mx-auto grid sm:grid-cols-5 gap-14 py-12 px-4'>
                    <motion.div 
                        ...
                        transition={{ duration: 0.8 }}
                    >
                        <img src={agentImg} alt="" className='w-full' />
                    </motion.div>
                    <motion.div 
            ...
            >
                ...
                <motion.div 
                    className='grid sm:grid-cols-5 grid-cols-2 gap-5 px-4'
                ...
                >
                    {automationStack.map((data, index) => (
                        <motion.div 
                            key={index} 
                            className='bg-colorLight text-center flex flex-col items-center text-sm dark:bg-colorDark px-4 py-5 text-zinc-600 rounded-xl'
                            variants={fadeInUp}
                            whileHover={{ scale: 1.05 }}
                        >
                            <data.img />
                            <h4 className=' text-[12px] py-2'>{data.title}</h4>
                        </motion.div>
                    ))}
                </motion.div>
                ...
                <div>
                    <img src={vidImg} alt="" className=' mx-auto' />
                </div>
            </motion.section>
