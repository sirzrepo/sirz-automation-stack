...
import { Component4, digitalImg, ecommerceImg, icon, icon2, icon3, store, } from "../../assets";
...
export default function DigitalMarketing() {
        const selectedKeys = pageCardSelections["digitalMarketing"];
            ...
            <section className=" min-h-screen relative text-white py-16 md:py-24">
                 <motion.div className=" text-black rounded-lg">
                    <div className="lg:grid grid-cols-2 w-[90%] gap-10 mx-auto  ">
                        <img src={digitalImg} alt="" className=" mx-auto max-lg:hidden " />
                        ...
                        <div className="flex 2xl:w-[80%] flex-col relative z-10 lg:py-16 ">
                            <div className=" pb-20 max-md:pt-10">
                                ...
                                Your 24/7 digital marketing team—powered by AI. Launch email campaigns, track performance, generate content, and manage your social media, all from one dashboard. Smarter campaigns. Better ROI.
                                </div>
                                <div className="gap-6">
