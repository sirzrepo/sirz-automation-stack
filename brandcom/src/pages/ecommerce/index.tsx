...
import { Component4, ecommerceImg, icon, icon2, icon3, serviceIcon, } from "../../assets";
...
export default function Ecommerce() {
            const selectedKeys = pageCardSelections["ecommerce"];
            ...
            <section className=" min-h-screen relative text-white py-16 md:py-24">
                 <motion.div className=" text-black rounded-lg">
                    <div className="lg:grid grid-cols-2 w-[90%] gap-10 mx-auto  ">
                        <img src={ecommerceImg} alt="" className=" mx-auto max-lg:hidden " />
                        ...
                        <div className="flex 2xl:w-[80%] flex-col relative z-10 lg:py-16 ">
                            <div className=" pb-20 max-md:pt-10">
                                ...
                                Automate your store’s success. From product page creation to abandoned cart emails and upsell strategies, Brandcom streamlines your workflow so you can focus on growing, not managing.
                                </div>
                                <div className="gap-6">
